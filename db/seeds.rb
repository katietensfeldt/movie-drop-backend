...
User.create(name: "Katie", username: "k10sfeldt", email: "katie@test.com", password: "password")
User.create(name: "Mike", username: "lordascendant", email: "mike@test.com", password: "password")
User.create(name: "Dani", username: "daniiscool", email: "dani@test.com", password: "password")
